...
schädlich, also empfehle ich es zu leeren.
    ...
    Die Klassendiagramme für die CLI und den Daemon sind im Anhang unter \hyperref[sec:class-diag-cli]{Klassendiagramm CLI} und \hyperref[sec:class-diag-daemon]{Klassendiagramm Daemon} zu finden.
...
echo ts run >> ~/.zprofile
    ...
    \footnotetext[3]{
        Falls das Diagramm nicht optimal dargestellt wird, kann es im Abgabeordner unter folgenden Pfaden gefunden werden:
        \texttt{docs/diagrams/intellij/daemon.umll} bzw. \texttt{docs/assets/daemon\_class\_diag.png}
    }
    \vspace*{\fill}

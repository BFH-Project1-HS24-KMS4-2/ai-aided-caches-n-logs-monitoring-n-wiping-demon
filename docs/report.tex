...
monitoring database.
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{7cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & Mittelwert der Zeit in Millisekunden aus mehreren Stichproben \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{5cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & 8'800ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{5cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & 800ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{5cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & 6.6ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{5cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & 0.6ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{5cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & 21ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{5cm}|}
            ...
            \textbf{Stichprobenmittel der Zeit} & 2'663ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{7cm}|p{7cm}|}
            ...
            \textbf{Durchschnittliche Zeit zum Erstellen eines Snapshots} & Durchschnittliche Zeit, die benötigt wurde, um einen Snapshot zu erstellen \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{5cm}|p{10cm}|}
            ...
            \textbf{Durchschnittliche Zeit zum Erstellen eines Snapshots} & 670ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{5cm}|p{10cm}|}
            ...
            \textbf{Durchschnittliche Zeit zum Erstellen eines Snapshots} & 914ms \\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|p{5cm}|p{10cm}|}
            ...
            \textbf{Durchschnittliche Zeit zum Erstellen eines Snapshots} & 173ms \\ \hline
        \end{tabular}

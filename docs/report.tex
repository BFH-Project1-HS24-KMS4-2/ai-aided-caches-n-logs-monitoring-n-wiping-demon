...
Des Weiteren lassen sich Schlüsse aus Änderungen, Löschungen und Neuerstellungen von Dateien ziehen.\footnote{Evalutation durch KI-Modell nicht weiter realisiert, siehe Kapitel \nameref{sec:zukunftigearbeiten}.}
...
Das Lieferobjekt soll von einem zentralen Repository heruntergeladen werden können,
plattformunabhängig sein und mit einem User-Manual ausgestattet sein. Es soll OnDemand Search und periodisches Monitoring spezifizierter Dateipfade ermöglichen,
indem es Einschätzungen von AI-Modellen einholt.
Das AI-Modell wird nur abgefragt bzw. eingebunden und dessen Entwicklung und
Betrieb wird vom Projekt abgegrenzt und als gegebene Verfügbarkeit vorausgesetzt.

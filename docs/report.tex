...
<Inhalt der Datei>
    ...
    Die Sprints leben ebenfalls auf Stufe einer Group in Gitlab.
    Sie werden als Iterations bezeichnet.
    Issues können explizit zu einer Iteration zugewiesen werden.

    \subsubsection{Taskboard} % todo: mby image

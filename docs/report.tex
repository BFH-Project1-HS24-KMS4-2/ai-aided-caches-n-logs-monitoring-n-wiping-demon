...
...
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{10cm}|}
            ...
            \begin{itemize}
                \item Daemon läuft
                \item Pfad wurde noch nicht hinzugefügt
            \end{itemize} \\ \hline
            \textbf{Ablauf} &
            \begin{enumerate}
                \item \begin{verbatim}ts monitor add
<TraceSentry Installationsverzeichnis>\end{verbatim}
                \item Erwartet: \begin{verbatim}Hinzugefügt\end{verbatim}
                \item \begin{verbatim}ts monitor list\end{verbatim}
                \item Erwartet: Der hinzugefügte Pfad wird aufgelistet.
                \item \begin{verbatim}ts monitor remove
<TraceSentry Installationsverzeichnis>\end{verbatim}
                \item Erwartet: \begin{verbatim}Removed\end{verbatim}
                \item \begin{verbatim}ts monitor list\end{verbatim}
                \item Erwartet: Der gelöschte Pfad wird nicht mehr aufgelistet.
            \end{enumerate} \\ \hline
            \textbf{Erwartetes Ergebnis} & Ein Pfad, der noch nicht hinzugefügt wurde, kann ohne Fehler hinzugefügt und anschliessend wieder entfernt werden.
            Dabei wird auch der aktuelle Zustand mit der list-Anweisung immer korrekt ausgegeben.\\ \hline
        \end{tabular}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{10cm}|}
            ...
            \textbf{Beschreibung} & Pfad zum Überwachen mit Mode und der Option (ohne Unterordner) hinzufügen.         \\ \hline
            \textbf{Vorbedingungen} &
            \begin{itemize}
                \item Daemon läuft
                \item Pfad wurde noch nicht hinzugefügt
            ...
            \begin{enumerate}
                \item \begin{verbatim}ts monitor add
<TraceSentry Installationsverzeichnis>
--mode LOG --no-subdirs\end{verbatim}
                \item Erwartet: \begin{verbatim}Hinzugefügt\end{verbatim}
                \item \begin{verbatim}ts monitor list\end{verbatim}
                \item Erwartet: Pfad wird mit Mode=LOG und No Subdirs=true aufgelistet.
            \end{enumerate} \\ \hline
            \textbf{Erwartetes Ergebnis} & Ein Pfad, der noch nicht hinzugefügt wurde, kann mit den gewünschten Optionen hinzugefügt werden.
            Danach wird mit der list-Anweisung der aktuelle Zustand korrekt ausgegeben. \\ \hline
        \end{tabular}
...
--pattern ^ts_.*_ts$\end{verbatim}
                \item Erwartet: Hinzugefügt
                \item \begin{verbatim}ts monitor list\end{verbatim}
                \item Erwartet: Pfad wird mit pattern=\begin{verbatim}^ts_.*_ts$\end{verbatim} aufgelistet.
            \end{enumerate} \\ \hline
            \textbf{Erwartetes Ergebnis} & Ein Pfad, der noch nicht hinzugefügt wurde, kann mit einem gewünschten Regex Pattern hinzugefügt werden.
            Danach wird mit der list-Anweisung der neue Zustand korrekt ausgegeben.\\ \hline
        \end{tabular}

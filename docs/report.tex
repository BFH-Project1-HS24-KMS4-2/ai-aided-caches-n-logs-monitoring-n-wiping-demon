...
schädlich, also empfehle ich es zu leeren.
    ...
    \subsubsection{}Das System besteht aus zwei Hauptkomponenten, welche als eigene Laufzeiteinheiten ausgeführt werden.
    ...
    TODO Büsnei Logik & Komplexität
    \\

    \subsubsubsection{\textbf{Geschäftslogik}}
    \\
    Das folgende Sequenzdiagramm zeigt eine typische Interaktion zwischen Implementationen von Subkomponenten gemäss Lösungsarchitektur.
    ...
    \subsubsubsection{\textbf{Monitoring Scheduler}}
    \\Der Monitoring Scheduler ist eine Implementation des Operations Schedulers (Lösungsarchitektur).
    ...
    Für jeden Knoten des Baumes werden die Hashes mit dem letzten Snapshot verglichen und ein Flag gesetzt, ob sich der Knoten geändert hat.
...
monitoring database.
    ...
    \clearpage
    \section{KI Fallstudie}\label{sec:ki-case-study}
    ...
    Es wurden insgesamt 48 Logdateien generiert und per Inspektionsfunktion an das KI-Modell übergeben.

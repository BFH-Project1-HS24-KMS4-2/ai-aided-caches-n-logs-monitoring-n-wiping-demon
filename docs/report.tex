...
schädlich, also empfehle ich es zu leeren.
    ...
    Ein vollsändiges Klassendiagramm kann im Anhang~\nameref{sec:klassendiagramm} gefunden werden. TODO
...
echo ts run >> ~/.zprofile
    ...
    \includepdf[pages=1, pagecommand={
        \section{Originale Projektbeschreibung}}]{../misc/proposal.pdf}
    \includepdf[pages=2-]{../misc/proposal.pdf}

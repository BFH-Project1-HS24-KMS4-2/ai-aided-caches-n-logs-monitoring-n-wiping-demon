...
% Abstract
    \begin{abstract}
        ...
        In einer praxisorientierten Fallstudie wurde das \gls{kimodell} \textit{\gls{gpt}-4o Mini} von \gls{openai} ausgewählt und evaluiert, um Dateiinhalte zu bewerten und potenzielle Risiken zu erkennen.
        Die Anwendung umfasst eine Befehlszeilenschnittstelle (\gls{cli}) und einen Hintergrundprozess (\gls{daemon}), der in regelmäßigen Abständen Snapshots der überwachten Verzeichnisse erstellt.
        ...
        Die modulare Architektur der Anwendung, die in \gls{java} unter Verwendung des Spring-Frameworks implementiert wurde, ermöglicht die Erweiterung um zusätzliche Funktionen oder Benutzeroberflächen.
...
% Main Content
    ...
    Alle Softwarekomponenten wurden in Java unter der Verwendung des \gls{spring}-Frameworks entwickelt.
...
internal/cache.json
        ...
        Dafür nutzt er den snapshots compare-Befehl, um alle Zustände des Verzeichnisses vom aktuellen Zeitpunkt bis zum Start der Überwachung vergleichen zu können.
...
index forbidden by rule: /var/www/html/
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=1\textwidth]{assets/DeplDiagram-v2} % todo: update diag

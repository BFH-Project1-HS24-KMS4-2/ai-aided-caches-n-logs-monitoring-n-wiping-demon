...
monitoring database.
    ...
    \subsubsection{Verwendete Umgebungsangaben und Metriken}\label{subsubsec:beschreibung-der-metriken-und-umgebung}
    \begin{table}[h!]
        \centering
        \setlength{\leftmargini}{0.8cm}
        ...
        \end{tabular}
        \caption{Beschreibung Umgebungsangaben und Metriken}\label{tab:search-perftest-metrics}
    \end{table}

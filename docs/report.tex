...
echo ts run >> ~/.zprofile
    ...
    TODO
    incl. the calculation of the estimated
    ...
    Der generelle technische Aufbau des Systems und insbesondere deren Architektur bieten die Möglichkeit zusätzliche Clients zu entwickeln.
    ...
    Die REST-Schnittstelle des Daemons bietet die notwendige Flexibilität, um eine solche GUI zu entwickeln.
    ...
    Generelle Ideen für zukünfitge Features:
    \begin{itemize}
        \item \textbf{Individuelle Monitoring Intervalle}: Der Anwender sollte die Möglichkeit haben, die Periodizität des Monitorings pro überwachter Datei individuell einzustellen.
        \item \textbf{Monitoring von geschützen Verzeichnissen/Dateien}: Der Anwender sollte die Möglichkeit haben (eventuell mit Erfordernissen via Betriebssystems), geschützte Verzeichnisse/Dateien zu überwachen.
        \item \textbf{Schlüsse aus Änderungen ziehen}: Die Abfrage des KI-Modells könnte erweitert werden, um nicht nur Dateiinhalte zu analysieren, sondern auch Schlüsse aus Änderungen, Löschungen und Neuerstellungen von Dateien(-metadaten) und/oder Dateiinhalten zu ziehen.
    \end{itemize}
    ...
    \footnotetext[3]{
        ...
        \texttt{docs/diagrams/intellij/cli.uml} bzw. \texttt{docs/assets/cli\_class\_diag.png}
    }
    \vspace*{\fill}
    ...
    \footnotetext[3]{
        Falls das Diagramm nicht optimal dargestellt wird, kann es im Abgabeordner unter folgenden Pfaden gefunden werden:
        \texttt{docs/diagrams/intellij/daemon.uml} bzw. \texttt{docs/assets/daemon\_class\_diag.png}
    }
    \vspace*{\fill}
    ...
    \footnotetext[2]{
        Falls das Diagramm nicht optimal dargestellt wird, kann es im Abgabeordner unter folgenden Pfaden gefunden werden:
        \texttt{docs/diagrams/intellij/lib.uml} bzw. \texttt{docs/assets/lib\_class\_diag.png}
    }
    \vspace*{\fill}

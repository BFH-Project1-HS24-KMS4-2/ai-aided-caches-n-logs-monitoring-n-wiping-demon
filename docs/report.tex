...
% Main Content
    ...
    Gemäss Anforderungsspezifikation wird ein KI-Modell\index{KI-Modell} zur Bewertung von Dateien eingebunden.
    Die Entwicklung eines eigenen KI-Modells ist nicht Teil dieser Arbeit.
    Stattdessen wurde das KI-Modell \textit{\gls{gpt}-4o mini} von \gls{openai} verwendet.
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{10cm}|}
            ...
            \begin{itemize}
                ...
                \item Alle Konfigurationen und Aktionen des Daemon sind via CLI verfügbar.
            \end{itemize}
            \\ \hline
        \end{tabular}
...
internal/cache.json
        ...
        Also fügt er diesen Pfad mit dem \texttt{monitor}-Befehl hinzu und schon wird dieses Verzeichnis vom TraceSentry stündlich überwacht.
...
test.log CHANGED 7-times
        ...
        Es resultiert eine standardisierte Ausgabe:
        %TODO richtiges Beispiel
        \begin{verbatim}

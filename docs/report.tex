    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{10cm}|}
            ...
            \begin{enumerate}
                ...
                \item \begin{verbatim}ts snapshots list {ID des zu überwachenden Pfads} {\end{verbatim}
                ...
                \item \begin{verbatim}ts snapshots compare {ID des zu überwachenden Pfads}\end{verbatim}
                ...
                \item \begin{verbatim}ts snapshots compare {ID des zu überwachenden Pfads} --start 4 --end 5\end{verbatim}
                \item Erwartet: Unterschied in der Datei test.log wird aufgelistet.
            \end{enumerate} \\ \hline

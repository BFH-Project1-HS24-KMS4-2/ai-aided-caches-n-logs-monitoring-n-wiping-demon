...
% Main Content
    ...
    Priorisiert sollen dabei in erster Linie Funktionalitäten eines \gls{mvp} (Minimum Viable Product) sein, welche die Kernfunktionalität des Produkts sicherstellen. % TODO Kernfunktionalität Einzahl korrekt?
    ...
    \begin{itemize}
        \item \textbf{Mocking von Ressourcen}: Verwenden von Mocks für Datenbank- und Dateisystemzugriffe in den Unit-Tests, um sie isoliert zu halten. % TODO komisch formuliert
        ...
        \item \textbf{Automatisierte Testausführung}: Integration der Tests in die CI/CD-Pipeline, um sicherzustellen, dass das System stabil bleibt. % TODO haben wir nicht?
    \end{itemize}
...
index forbidden by rule: /var/www/html/
    ...
    Angenommen die System-Prompt und Completion soll 2'000 Tokens lang sein, so könnte ein Logdatei mit maximal \sfrac{128'000 - 2'000}{40} = 3'150 Zeilen analysiert werden.

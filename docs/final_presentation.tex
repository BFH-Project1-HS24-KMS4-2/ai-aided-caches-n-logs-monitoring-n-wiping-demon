...
\begin{document}
    ...
    \begin{frame}{Architektur}
        \begin{center}
            \includegraphics[width=0.7\textwidth]{assets/DeplDiagram} % todo: replace with new diagram
        \end{center}
    \end{frame}
        ...
        \begin{columns}[t]
            ...
            \begin{column}{0.5\textwidth}
                ...
                \begin{itemize}
                    ...
                    \note{hat gut funktioniert mit 1 wöchigen Sprints, Probleme im Team wurden immer direkt angesprochen und geklärt,
                        Verbesserungspotential erkannten wir auch}
                    ...
                    \note{Velocity war schwierig konstant zu halten und Commitment war eher nach Gefühl.
                    Burndown-Chart so nicht wirklich hilfreich.}
                \end{itemize}
            \end{column}
    ...
    \begin{frame}{Fazit}
        ...
        \end{itemize}
    \end{frame}
    \note{bei weitem noch nicht ausgeschöpft, weshalb Luca jetzt noch etwas zum Ausblick sagt}

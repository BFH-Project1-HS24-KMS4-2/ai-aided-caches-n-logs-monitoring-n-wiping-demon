...
\usepackage{wasysym}
\usepackage{parskip} % Include this in the preamble
...
% Main Content
    ...
    \textbf{Begründung CLI} Auch hier haben wir für uns entschieden das Projekt mit der simpleren Variante bzw.
    Variante mit weniger Aufwand (also CLI) zu starten.
    Es geht in erster Linie auch um die Funktionalität, welche wir auch problemlos mit der CLI-Variante nutzen können.
    Das Ziel ist es auch (noch) nicht das System schon maximal benutzerfreundlich zu entwickeln und für einen möglichst grossen Markt anzubieten.
    ...
    Auch die Resultate könnten übersichtlicher dargestellt werden.
    ...
    \textbf{Nachteile}
    \begin{itemize}
        \item Eigenes Format muss für Files definiert werden (muss auch geparst werden)
    ...
    \textbf{3. Sockets}
    Das sind einfache Netzwerk-Sockets, auf die binäre Daten geschrieben oder von ihnen auch gelesen werden kann.
    ...
    Dadurch haben wir auch weniger Aufwand mit der Definition und dem Parsen von irgendwelchen Formaten.
    Ausserdem basiert Rest sowieso auch auf Sockets, was somit fast auf das Gleiche herauskommt.

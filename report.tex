...
% Main Content
    ...
    was einer Komplexität von $O(n)$ für das Traversieren und somit auch für den Bau entspricht.
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Kein sich lohnender Mehrwert an Performance gegenüber dem Laden aus der DB, da die DB lokal ist und das Query
            eine tiefe Komplexität hat.
        \end{itemize}

...
% Main Content
    ...
    \begin{itemize}
        \item Sicherstellen, dass der Daemon stabil läuft und seine Hauptfunktionen zuverlässig ausführt.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{REST-HTTP-Anfragen}: Testen, ob die CLI-Befehle Anfragen korrekt an den Daemon senden und er antwortet.
        \end{itemize}
        \item \textbf{Funktionale Tests}: Fokus auf End-to-End-Szenarien zur Validierung der zentralen Funktionalität.
    \end{itemize}
